...
export const dashboardMockData: DashboardDataSource = {
  ...
  campaigns: [
    { id: "campaign-july-promotion", brandId: "brand-coffee-xyz", brandName: "Coffee XYZ", name: "July Promotion", startDate: "2026-07-01", endDate: "2026-07-31", status: "active", completedPosts: 16, readyPosts: 3, totalPosts: 20, platforms: ["instagram", "tiktok", "youtube", "facebook"], icon: "spark", color: "bg-blue-600", textColor: "text-blue-700" },
    { id: "campaign-education-series", brandId: "brand-coffee-xyz", brandName: "Coffee XYZ", name: "Education Series", startDate: "2026-07-01", endDate: "2026-07-20", status: "planning", completedPosts: 12, readyPosts: 4, totalPosts: 20, platforms: ["instagram", "youtube", "facebook"], icon: "idea", color: "bg-indigo-600", textColor: "text-indigo-700" },
