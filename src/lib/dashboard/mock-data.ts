...
export const dashboardMockData: DashboardDataSource = {
  ...
  campaigns: [
    { id: "campaign-july-promotion", brandId: "brand-coffee-xyz", brandName: "Coffee XYZ", name: "July Promotion", startDate: "2026-07-01", endDate: "2026-07-31", status: "active", completedPosts: 16, readyPosts: 3, totalPosts: 20, platforms: ["instagram", "tiktok", "facebook", "linkedin"], icon: "spark", color: "bg-blue-600", textColor: "text-blue-700" },
    { id: "campaign-education-series", brandId: "brand-coffee-xyz", brandName: "Coffee XYZ", name: "Education Series", startDate: "2026-07-01", endDate: "2026-07-20", status: "planning", completedPosts: 12, readyPosts: 4, totalPosts: 20, platforms: ["instagram", "linkedin", "youtube"], icon: "idea", color: "bg-indigo-600", textColor: "text-indigo-700" },
    { id: "campaign-summer-wellness", brandId: "brand-skincare-abc", brandName: "SkinCare ABC", name: "Summer Wellness", startDate: "2026-07-10", endDate: "2026-08-10", status: "draft", completedPosts: 3, readyPosts: 2, totalPosts: 20, platforms: ["instagram", "tiktok"], icon: "check", color: "bg-emerald-600", textColor: "text-emerald-700" },
    { id: "campaign-healthy-habits", brandId: "brand-klinik-sehat", brandName: "Klinik Sehat", name: "Healthy Habits", startDate: "2026-07-05", endDate: "2026-07-28", status: "paused", completedPosts: 5, readyPosts: 1, totalPosts: 10, platforms: ["facebook"], icon: "idea", color: "bg-amber-600", textColor: "text-amber-700" },
  ],
  attentionItems: [
  ...
  activities: [
    ...
    { id: "activity-post-scheduled", scope: "brand", brandId: "brand-coffee-xyz", brandName: "Coffee XYZ", campaignId: "campaign-education-series", type: "post_scheduled", actorName: "Ari Pratama", actorInitials: "AP", action: "scheduled", entityName: "LinkedIn Education Post", supportingContext: "Education Series", occurredAt: "2026-07-11T09:45:00+07:00", href: "/calendar" },
