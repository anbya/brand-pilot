...
export default function DashboardPage() {
  ...
  return <div className="min-h-screen min-w-0 bg-[#f8f9ff] text-[#0b1c30]">
    <DashboardSidebar user={dashboardMockData.user} canCreateCampaign={permissions.canCreateCampaign} />
    <main id="dashboard-content" className="min-w-0 lg:pl-64"><DashboardClient dataSource={dashboardMockData} permissions={permissions} initialDateRangeId="range-july" initialScenario={dashboardStateScenarios.ready} /></main>
