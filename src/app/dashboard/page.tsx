...
export default function DashboardPage() {
  ...
  return <div className="min-h-screen min-w-0 bg-[#f8f9ff] text-[#0b1c30]">
    <main id="dashboard-content" className="bp-page"><DashboardClient dataSource={dashboardMockData} permissions={permissions} initialDateRangeId="range-july" initialScenario={dashboardStateScenarios.ready} /></main>
