...
const statusStyles = { draft: "bg-slate-100 text-slate-700", ready: "bg-emerald-100 text-emerald-800", scheduled: "bg-blue-100 text-blue-800", publishing: "bg-amber-100 text-amber-800", published: "bg-violet-100 text-violet-800", failed: "bg-rose-100 text-rose-800" } as const;
