...
type MonthGridProps = { currentDate: string; events: CalendarEventViewModel[]; highlightedVersionIds: ReadonlySet<string>; today: string; onEventClick: (versionId: string) => void; onMoreClick: (date: string) => void };
